...
本学习计划旨在学习前端开发最常用的Typescript技术，实现从 Java 开发者转型到 TypeScript 全栈开发，独立开发产品的能力。

---

## 第一部分：常用的 TypeScript 知识

以下列出的知识点，是写TypeScript代码时 80% 的时间都会用到的功能。
...
这些知识点写代码时不会经常用到，但是对学习和理解 TypeScript 的框架比如 NestJS 很有帮助。
